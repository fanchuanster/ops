...
// env.php first: storage.php and social-login.php both read credentials
// through its nr_env() helper.
require_once NR_PLUGIN_DIR . 'includes/env.php';
require_once NR_PLUGIN_DIR . 'includes/post-types.php';
// storage.php before meta-boxes.php/access.php: both call its functions
// (sync-on-save, resolving a part's file) directly, not through a hook.
require_once NR_PLUGIN_DIR . 'includes/storage.php';
require_once NR_PLUGIN_DIR . 'includes/meta-boxes.php';
require_once NR_PLUGIN_DIR . 'includes/rate-limit.php';
require_once NR_PLUGIN_DIR . 'includes/staged-release.php';
require_once NR_PLUGIN_DIR . 'includes/access.php';
require_once NR_PLUGIN_DIR . 'includes/downloads.php';
require_once NR_PLUGIN_DIR . 'includes/reader.php';
require_once NR_PLUGIN_DIR . 'includes/auth.php';
require_once NR_PLUGIN_DIR . 'includes/social-login.php';
...
require_once NR_PLUGIN_DIR . 'includes/cli.php';
